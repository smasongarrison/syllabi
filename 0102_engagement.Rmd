...
+ As long as you've communicated *within `r gracewindow`*, I will do my best to work with you to come up with a new deadline or modification, so that you can earn full credit. + Any modifiation or change of deadline must be confirmed in writing. And must be done for each modification.
+ This late policy does not apply to exams, tests, or quizzes. 

If contact is not made *within `r gracewindow`* of the missed deadline, the missing assignment will receive a 0 and can not be made up. 
