...
topic =c(
  "Introduction", 
  "Getting Ready to Do Statistical Analysis",
  "The Scientific Process, Types of StudiesDescribing Data with R",
  "Univariate Distributions",
  "Test 1",
  "Bivariate Distributions",
  "Probability Theory",#  "Spring Break",#  "",
...
quizes<-c(4,7,11,14,17)
assignments<-c(8,15)
classschedule$milestones[quizes] <- "Quiz"
...
- Quiz 1: Friday, `r advdate(dayone, quizes[1], assignment="f")`

- Quiz 2: Friday, `r advdate(dayone, quizes[2], assignment="f")`

- Quiz 3: Friday, `r advdate(dayone, quizes[3], assignment="f")`

- Quiz 4: Friday, `r advdate(dayone, quizes[4], assignment="f")`

- Quiz 5: During Finals, `r advdate(dayone, quizes[5], assignment="f")`
...
- Assignment 1: Friday, `r advdate(dayone, assignments[1], assignment="f")`: Problem Set 1 and Qualitative Critique 1

- Assignment 2: Friday, `r advdate(dayone, assignments[2], assignment="f")`: Problem Set 2 and Qualitative Critique 2
