...
For all written assignments in my class, students have access to their Turnitin report via canvas.  If you are uncertain if something violates the honor code or is plagiarism, ask *in advance*.
...
Students who need reasonable accommodations for disabilities also should contact the Learning Assistance Center \& Disability Services [lac.wfu.edu](https://lac.wfu.edu/). These accommodations are not retroactive. Therefore, I strongly encourage you to use those accommodations. They are yours by legal and moral right. 
