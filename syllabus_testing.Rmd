...
- Quiz 3: Friday, `r advdate(mon, 9, assignment="f")`

- Quiz 4: Friday, `r advdate(mon, 12, assignment="f")`
...
The best two (2) out of three (3) qualitative aspects will be used to determine your qualitative score. I will provide more specific written guidelines at least two weeks before each assignment is due. You have to submit assignment 1 because I give extensive feedback that will help you on later assignments. However, you may skip assignment 2 or 3.


### Assignment Dates

- Assignment 1: Friday, `r advdate(mon, 6, assignment="f")`: Set 1 and Critique of an online test.

- Assignment 2: Friday, `r advdate(mon, 12, assignment="f")`: Set 2 and Critique of a testing-related popular media article.
...
The best two (2) out of three (3) sets will be used to determine your total problem set score.  You have to submit assignment 1 because I give extensive feedback that will help you on later assignments. However, you may skip assignment 2 or 3.You can skip one of the assignments for any reason. However, I strongly encourage you to attempt each problem set.
...
## Qualitative Aspects 
These qualitative assignments will allow you to incorporate some of your own interests into the course. Such interests could be related to your career, another class you're taking, a hobby you're exploring, or some other random fancy. They will typically be approximately two (2) pages.


The best two (2) out of three (3) qualitative assignments will be used to determine your total qualitative assignment score. You have to submit assignment 1 because I give extensive feedback that will help you on later assignments. However, you may skip assignment 2 or 3.
...
- 100 points of your grade will be determined by your best two (2) problem sets.
- 100 points of your grade will be determined by your best two (2) writing assignments.
