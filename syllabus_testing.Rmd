...
## Quizzes
There will be 6 quizzes in this course.  The best 5 out of 6 quiz grades will be used to determine your total quiz grade.  You can drop 1 of the quizzes for any reason.
...
- Quiz 2: Friday, `r advdate(mon, 5, assignment="f")`

- Quiz 3: Friday, `r advdate(mon, 8, assignment="f")`

- Quiz 4: Friday, `r advdate(mon, 10, assignment="f")`

- Quiz 5: Friday, `r advdate(mon, 12, assignment="f")`

- Quiz 6: Friday, `r advdate(mon, 15, assignment="f")`



## Research Project
There will be one (1) research project in this course, in five stages. I will provide more specific written guidelines at least two weeks before each stage is due.

### Research Project Milestones

- Stage 1: Friday, `r advdate(mon, 4, assignment="f")`: XXXXXXXXXXXXX

- Stage 2: Friday, `r advdate(mon, 8, assignment="f")`: XXXXXXXXXXXXX

- Stage 3: Friday, `r advdate(mon, 12, assignment="f")`: XXXXXXXXXXXXX

- Stage 4: Friday, `r advdate(mon, 14, assignment="f")`: XXXXXXXXXXXXX

- Stage 5: Friday, `r advdate(mon, 15, assignment="f")`: Final Product
...
- 150 points of your grade will be determined by your research project.
