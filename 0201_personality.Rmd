...
- Quiz 1: Friday, `r advdate(first_day, exams[1], weekday_due="f")`

- Quiz 2: Friday, `r advdate(first_day, exams[2], weekday_due="f")`

- Quiz 3: Friday, `r advdate(first_day, exams[3], weekday_due="f")`

- Quiz 4: Friday, `r advdate(first_day, exams[4], weekday_due="f")`

- Quiz 5: Friday, `r advdate(first_day, exams[5], weekday_due="f")`

- Quiz 6: During Finals, `r advdate(first_day, exams[6], weekday_due="f")`
...
- Assignment 1: Friday, `r advdate(first_day, assignments[1], weekday_due="f")`: Critique of an online personality test.

- Assignment 2: Friday, `r advdate(first_day, assignments[2], weekday_due="f")`: Critique of a personality-related media article.

- Assignment 3: Friday, `r advdate(first_day, assignments[3], weekday_due="f")`: Critique of a personality-related YouTube video.
