...
Data Science for Psychologists (CN4P) introduces on the principles of data science, including:
...
This module is designed to introduce you to COURSE NAME. Please watch the videos and work your way through the notes. **The videos start on the next page.**  You can find the module playlist [here][pl-01]. Most of the slides used to make the videos in this module can be found in the [slides repo][slides].
