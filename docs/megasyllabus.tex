...
\section*{How to use this syllabus}\label{how-to-use-this-syllabus}
...
This syllabus was written in \href{http://bookdown.org/}{bookdown} inside \href{http://www.rstudio.com/ide/}{RStudio}. The \href{https://smasongarrison.github.io/syllabi}{website} is hosted with \href{https://www.github.com}{github}, The complete source is available from \href{https://github.com/smasongarrison/syllabi}{github}.
...
(Now, before I forget, any matter not explicitly covered by the syllabus or institution-wide policy is left to my sole discretion as the instructor. See \hyperref[policy-overview]{policy overview}
...
In previous semesters, I maintained a deliberately hard-line attendance policy. However, in light of ongoing public health concerns and my philosophy of treating students as junior colleagues, I've revised this approach.
...
\item
  ...
  \tightlist
  \item
    Email me within \emph{within 36 hours} of the missed Final Deadline.
  \item
  ...
  \item
    If you communicate \emph{within 36 hours} window, I will do my best to work with you to find a solution that allows you to earn full credit.
  \end{itemize}
\item
...
\item
  If no contact is made within \emph{within 36 hours} of the missed Final Deadline, the assignment will receive a 0 and cannot be made up.
\item
...
\item
  \href{https://www.apa.org/pi/disability/dart/}{American Psychological Association's DisABILITY Resources Toolbox (DART)}
\item
...
\section{Ethical Use of Artificial Intelligence}\label{ethical-use-of-artificial-intelligence}

Note: This policy's language was adapted from this \href{https://www.reddit.com/r/Professors/comments/11mmz8k/the_ethical_use_of_artificial_intelligence/}{reddit post}
...
\subsection{Things that I thought didn't need to be said, but apparently did need to be said.}\label{things-that-i-thought-didnt-need-to-be-said-but-apparently-did-need-to-be-said.}
...
\subsubsection{\texorpdfstring{It is \emph{ALWAYS} academic dishonesty\ldots{}}{It is ALWAYS academic dishonesty\ldots{}}}\label{it-is-always-academic-dishonesty}
...
\item
  It is \emph{STILL} dishonest if you indirectly copy outside materials into a test or quiz.
\item
  It is \emph{STILL} dishonest if you then edit what you have copied. Frankly that is worse because you tried to hide that you did it.
\item
...
\item
  It is \emph{ALWAYS} academic dishonesty to work together on tests or quizzes. (And frankly, it is really obvious in Canvas when you work together. I literally wrote a R program that checks for working together on tests. )
\end{itemize}
...
\subsection{Requests for Re-Assessment}\label{requests-for-re-assessment}

Please send any questions about grades in writing via email within \emph{one} week after the assignment is returned. If I erred in scoring or in calculating the grade, I will happily update the record. Otherwise, I will be most receptive toward questions framed in terms of your learning (rather than simply your performance), as research has shown that focusing overly on extrinsic rewards (like grades) is likely to lead to all sorts of outcomes that I don't wish for you (lower interest in the course material, lower learning, lower enjoyment).
...
\subsection{Is it a true emergency?}\label{is-it-a-true-emergency}
...
\chapter*{210: Methods in Psych Research}\label{statsminor}
...
Morling, (5th Edition) Research Methods in Psychology \url{https://seagull.wwnorton.com/researchpsych5}
...
\caption{\label{tab:unnamed-chunk-5}Full Table}
\centering
\begin{tabular}[t]{l|r}
\hline
Letter & Cutoff\\
...
\section*{Engagement Activities}\label{engagement-activities}
...
\subsection*{Engagement Activities}\label{engagement-activities-1}
...
\caption{\label{tab:unnamed-chunk-7}Full Table}
\centering
\begin{tabular}[t]{l|r}
\hline
Letter & Cutoff\\
...
You will be formally evaluated in four different ways (Labs, Portfolio, Engagement, Reflection) Instructions for the assignments can be found in the \href{https://datascience4psych.github.io/DataScience4Psych/}{course notes}.
...
The major semester projects (\href{https://datascience4psych.github.io/DataScience4Psych/guidance.html\#portfolio}{described on the data science website}) are a set of DS4P Projects, which you will summarize in a DS4P Portfolio to be handed in on the last day of class. Instructions for \href{https://datascience4psych.github.io/DataScience4Psych/guidance.html\#portfolio}{the portfolio} can be found in the \href{https://datascience4psych.github.io/DataScience4Psych/}{course notes}.
...
\subsection*{Reflection and Summary}\label{reflection-and-summary}
...
\subsection*{What About Exceptional (or Mediocre) Work?}\label{what-about-exceptional-or-mediocre-work}
...
\subsection*{Contract Adjustments}\label{contract-adjustments}
...
\subsection*{Grading Policy}\label{grading-policy-3}
...
\chapter*{392: CI Wikipedia}\label{wikipedia}


\section*{Course Description}\label{course-description-4}


\textbf{PSY-392-F: Contemporary Issues in Psychology - Citation Needed: Psychology, Misinformation, and Wikipedia}
...
\subsection*{Guiding Question}\label{guiding-question}
...
\section*{Course Modality}\label{course-modality}


This is a half-semester course running from March 01 through April 28, 2025. Classes meet on Tuesdays and Thursdays.

\section*{Required Materials}\label{required-materials-3}


All course materials will be provided through the \href{https://dashboard.wikiedu.org/}{Wikipedia Education Dashboard}. Students will complete training modules and exercises through this platform.

\section*{Course Assignments}\label{course-assignments-4}


You will be formally evaluated in three different ways. Instructions for the assignments can be found on the \href{https://dashboard.wikiedu.org/}{Wikipedia Education Dashboard}.
...
\subsection*{Wikipedia Editing Project}\label{wikipedia-editing-project}
...
\subsection*{Weekly Journal}\label{weekly-journal}
...
\subsection*{Reflective Essay}\label{reflective-essay}
...
\textbf{Due:} 04/24 \href{https://dashboard.wikiedu.org/training/students/in-class-presentation-exercise}{View}

\section*{Grading Policy}\label{grading-policy-4}
...
I \emph{may} shift these thresholds down \emph{slightly} to provide a better fit to the actual point distribution. This shift can only help your grade.

\subsection*{Weighting}\label{weighting-1}
...
\chapter*{718: Data Science}\label{data-science}


\section*{Course Description}\label{course-description-5}
...
\section*{Required Materials}\label{required-materials-4}
...
\section*{Course Assignments}\label{course-assignments-5}
...
\subsection*{Portfolio}\label{portfolio-1}
...
\subsection*{Reflection and Summary}\label{reflection-and-summary-1}
...
\section*{Grading Policy}\label{grading-policy-5}
...
\section*{Contract Details}\label{contract-details-1}
...
\subsection*{What About Exceptional (or Mediocre) Work?}\label{what-about-exceptional-or-mediocre-work-1}
...
\subsection*{Contract Adjustments}\label{contract-adjustments-1}
...
\subsection*{Contract Grades}\label{contract-grades-1}


\subsection*{``A-'' Contract}\label{a--contract-1}
...
\subsection*{``B'' Contract}\label{b-contract-1}
...
\subsection*{``P'' Contract}\label{p-contract-1}
...
\section*{Tentative Module Release Schedule}\label{tentative-module-release-schedule-1}
...
\section{College Workload}\label{college-workload}

\href{https://registrar.wfu.edu/facultystaff-information/semester-credit-hour/}{WFU on Credit Hours}
...
\section{Addition pieces of advice:}\label{addition-pieces-of-advice}
...
\section*{FAQ Categories}\label{faq-categories}


\begin{itemize}
\tightlist
\item
  \hyperref[general]{General Course Questions}
\item
  \hyperref[grading]{Grading and Assignments}
\item
  \hyperref[materials]{Course Materials}
\item
  \hyperref[tech]{Technical Issues}
\item
  \hyperref[nos]{NOS}
\end{itemize}

\section{General Course Questions}\label{general}

\subsection{How can I get ahold of you?}\label{how-can-i-get-ahold-of-you}
...
\subsection{Where can I find the reading list for the entire semester?}\label{where-can-i-find-the-reading-list-for-the-entire-semester}

You can find the suggested readings for each module either on canvas or the GitHub course notes.

\subsection{Where can I find when assignments are due?}\label{where-can-i-find-when-assignments-are-due}

You can find due dates in the syllabus and on canvas.

\subsection{Where can I check the closing time of assessments?}\label{where-can-i-check-the-closing-time-of-assessments}
...
(Under the standard ``Carnegie Unit'', each credit hour corresponds to a \emph{minimum} of 3 hours of student engagement per week for a traditional 15-week course. See the WFU registrar for more details.)

\subsection{Can my parents email you about my class performance?}\label{can-my-parents-email-you-about-my-class-performance}

Unless you are legally a minor, I cannot answer your parents' questions about this class.

\subsection{Does it hurt to ask\ldots{}}\label{does-it-hurt-to-ask}
...
\section{Grading and Assignments}\label{grading}

\subsection{Where are my grades?}\label{where-are-my-grades}
...
\subsection{Can you bump up my grade?}\label{can-you-bump-up-my-grade}

No.~Please don't \href{https://undergraduateswrite.com/2019/05/10/i-say-grade-grubbing-you-say-it-doesnt-hurt-to-ask-on-asking-teachers-to-bump-your-final-grade/}{grade grub}. Don't ask for extra credit or special opportunities to boost your grade. No.~Please don't. \href{https://undergraduateswrite.com/2019/05/10/i-say-grade-grubbing-you-say-it-doesnt-hurt-to-ask-on-asking-teachers-to-bump-your-final-grade/}{Seriously, don't do it at the end of the semester.} Don't ask for extra credit or special opportunities to boost your grade. Please don't pull on my heartstrings about how you need a certain grade or there will be consequences for you. I know that many students think that it doesn't hurt to ask. It does. It hurts me. Although I care deeply about my students, I have to say no because it isn't equitable. So please don't ask for the grade boost. Seriously, I get enough emotional manipulation from my cats for leaving them at home all day.

\subsection{Can you calculate my grade for me?}\label{can-you-calculate-my-grade-for-me}

No.~You are capable of calculating a weighted average. You have all the information you need in the syllabus and the raw scores from Canvas. If you need help, try this website: \url{https://thegradecalculator.com/}

\subsection{What can I do to get a better grade?}\label{what-can-i-do-to-get-a-better-grade}

The work\ldots{}

\includegraphics[width=18.14in]{img/worriedgrade}

\subsection{\texorpdfstring{Why is the locked?}{Why is the  locked?}}\label{why-is-the-locked}
...
\subsection{Why do I have to meet with you if I want to see my test again?}\label{why-do-i-have-to-meet-with-you-if-i-want-to-see-my-test-again}
...
\subsection{Can't you just tell me my letter grade? Your curve is confusing.}\label{cant-you-just-tell-me-my-letter-grade-your-curve-is-confusing.}
...
For perspective on how curves can sometimes be used in harmful ways (particularly in competitive academic environments), see this video essay about how curves and scholarships work at a particular law school: \url{https://www.youtube.com/watch?v=4jYrRhtH2eI}. While my curve policy is designed to help students (not hurt them), it's worth understanding different approaches to grading curves in higher education.

\subsection{Does it hurt to ask\ldots{}}\label{does-it-hurt-to-ask-1}
...
\subsubsection{Where are my grades?}\label{where-are-my-grades-1}
...
If you're having trouble with Canvas, you should first search the \href{https://community.canvaslms.com/t5/Canvas-Basics-Guide/tkb-p/basics}{Canvas Guides} and then reach out to canvas support. Although I am not Canvas tech support, I have provided some answers and resources to commonly asked questions in a later {[}section{]}{[}canvas{]}.
...
\subsubsection{Can you calculate my grade for me?}\label{can-you-calculate-my-grade-for-me-1}
...
\subsubsection{Can my parents email you about my class performance?}\label{can-my-parents-email-you-about-my-class-performance-1}
...
\subsubsection{\texorpdfstring{Why is the locked?}{Why is the  locked?}}\label{why-is-the-locked-1}
...
\subsubsection{How much time should I spend on one class every week?}\label{how-much-time-should-i-spend-on-one-class-every-week-1}
...
\subsection{How do I use Canvas for class?}\label{how-do-i-use-canvas-for-class}
...
If you're having trouble with Canvas, you should search the \href{https://community.canvaslms.com/t5/Canvas-Basics-Guide/tkb-p/basics}{Canvas Guides} and then reach out to canvas support.

\subsection{How do I contact the Canvas Help Desk?}\label{how-do-i-contact-the-canvas-help-desk}
...
\subsection{Where can I find more information about WFU technology services or resources?}\label{where-can-i-find-more-information-about-wfu-technology-services-or-resources}

\begin{itemize}
\tightlist
\item
  WFU technology services: \url{https://is.wfu.edu/student/}
\item
  WFU's Service Status Dashboard: \url{https://status.is.wfu.edu/}
\end{itemize}

\subsection{I'm having trouble with a specific problem, can you fix it for me?}\label{im-having-trouble-with-a-specific-problem-can-you-fix-it-for-me}
...
You can check the length of the module playlist using this website: \url{https://ytplaylist-len.herokuapp.com/}. Each module has 1 week worth of lectures.
...
\section{Miscellaneous Questions}\label{nos}

\subsection{Why is your speaking style so weird?}\label{why-is-your-speaking-style-so-weird}
...
\subsection{Why did a question I asked via email show up on the discussion board?}\label{why-did-a-question-i-asked-via-email-show-up-on-the-discussion-board-1}
...
\textbf{\href{https://class.wfu.edu/}{Center for Learning, Access and Student Success}}
...
\begin{itemize}
\item
  \href{https://www.youtube.com/watch?v=E7CwqNHn_Ns&list=PL8dPuuaLjXtNcAJRf3bE1IJU6nMfHj86W}{Crash Course: Study Skills}
\item
  \href{https://vimeo.com/270014784?embedded=true&source=vimeo_logo&owner=2248721}{What are Office Hours?}
\item
  \href{https://www.youtube.com/watch?v=5zkAOpx8Qk8}{What Are Course Evals and Why Should You Submit Them}
\end{itemize}
...
\begin{itemize}
\item
  \href{https://www.loc.gov/programs/poetry-and-literature/poet-laureate/poet-laureate-projects/poetry-180/all-poems/item/poetry-180-013/did-i-miss-anything/}{Poem 013: Did I Miss Anything?}
\item
  \href{https://www.insidehighered.com/views/2015/04/16/advice-students-so-they-dont-sound-silly-emails-essay}{Advice for students so they don't sound silly in emails (essay)}
\end{itemize}
...
\begin{itemize}
\item
  \href{https://www.northeastern.edu/graduate/blog/tips-for-taking-online-classes/}{Tips for Taking Online Classes: 8 Strategies for Success Links to an external site.}
\item
  \href{https://www.youtube.com/watch?v=pLlv2o6UfTU&list=PL8dPuuaLjXtN07XYqqWSKpPrtNDiCHTzU}{Navigating Digital Information}
\end{itemize}
