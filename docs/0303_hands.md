...
<div>
<iframe src="https://www.youtube.com/embed/eeKBSjv7K6E" width="533" height="300" frameborder="0" allowfullscreen=""></iframe>
</div>
</div>
```
...
<iframe src="https://datascience4psych.github.io/slides/d09_wrangle/d09_wrangle.html" width="672" height="400px"></iframe>



## Activity 04: Hotels!

<iframe src="https://datascience4psych.github.io/slides/d09_wrangle/d09_wrangle.html#18" width="672" height="400px"></iframe>
...
<iframe src="https://datascience4psych.github.io/ae-04-hotels-datawrangling/hotels-datawrangling.html" width="672" height="400px"></iframe>



## ODD: Single table dplyr functions {#dplyr-single}
...
Previously, on [Introduction to dplyr](#dplyr-intro), we used two very important verbs and an operator:
...
* dplyr is a core package in the [tidyverse][tidyverse-github] meta-package. Because we often make incidental usage of the others, we will load dplyr and the others via `library(tidyverse)`.
