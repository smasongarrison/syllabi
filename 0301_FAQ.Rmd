...
```{r, echo=FALSE}
include_tweet("https://twitter.com/AlisonLedg/status/1441181845706579969")
```
...
The time you spend on a class can vary. No two instructors will format their classes exactly the same. Nevertheless, under the standard ["Carnegie Unit"]  (https://www.carnegiefoundation.org/faqs/carnegie-unit/), each credit hour corresponds to a *minimum* of 3 hours of student engagement per week for a traditional 15-week course. This time may be spent on discussions, readings, and lectures, study, and research, and assignments. See the WFU regristrar for [more detials](https://registrar.wfu.edu/semester-credit-hour/) if you'd like 
...
```{r, echo=FALSE}
include_tweet("https://twitter.com/BettySLai/status/1455555111397117954")
```
